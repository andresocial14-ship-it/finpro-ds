    ...
    #define RESET "\033[0m"
    #define GOLD_BOLD   "\033[1;38;2;255;215;0m"     /* Bold Gold text      */
    #define DARK_GOLD   "\033[38;2;184;134;11m"      /* Darker Gold         */
    #define WHITE_BOLD  "\033[1;37m"                 /* Bold White          */
    #define DIM         "\033[2;37m"                 /* Dimmed White        */
    #define FORM_PAD "\t\t\t\t\t\t\t   "
    #define PAD  "\t\t\t\t\t\t      "
    // ================================================================
    ...
    void book_ticket_banner(){
        printf("\n");
		printf(GOLD"\t\t\t\t=================================================================================================\n"RESET);
		
        printf(GREEN "\t\t\t\t         .---." RESET GOLD "          ____    ___    ___   _  __    _____  ___  ____  _  __ _____  _____      \n" RESET);
        printf(GREEN "\t\t\t\t        /  9 9\\ " RESET GOLD "       | __ )  / _ \\  / _ \\ | |/ /   |_   _||_ _|| ___|| |/ /| ____||_   _|     \n" RESET);
        printf(GREEN "\t\t\t\t       (      `\\ " RESET GOLD "      |  _ \\ | | | || | | || ' /      | |   | | | |   | ' / |  _|    | |       \n" RESET);
        printf(GREEN "\t\t\t\t       |\\\\ ,  ,| " RESET GOLD "      | |_) || |_| || |_| || . \\      | |   | | | |___| . \\ | |___   | |       \n" RESET);
        printf(GREEN "\t\t\t\t       | \\\\____/ " RESET GOLD "      |____/  \\___/  \\___/ |_|\\_\\     |_|  |___|\\____||_|\\_\\|_____|  |_|      \n" RESET);
        printf(GREEN "\t\t\t\t      /   `---' " RESET GOLD "                                                                   \n" RESET);
        printf(GREEN "\t\t\t\t     /      |   " RESET GOLD "                                                                  \n" RESET);
...
void cancel_banner(){
    printf(GOLD);
    printf("\t\t\t\t\t                    .-'-.                                                 \n");
    printf("\t\t\t\t\t                 __|_     `\\      ____    _    _   _  ____ _____ _       \n");
    printf("\t\t\t\t\t                `--,-`--._  `\\   / ___|  / \\  | \\ | |/ ___| ____| |      \n");
    printf("\t\t\t\t\t            []  .->'  a   `|-'  | |     / _ \\ |  \\| | |   |  _| | |      \n");
    printf("\t\t\t\t\t             `=/ (__/_     /|   | |___ / ___ \\| |\\  | |___| |___| |___   \n");
    printf("\t\t\t\t\t               \\\\_,    `  _)     \\____/_/   \\_\\_| \\_|\\____|_____|_____|  \n");
    printf("\t\t\t\t\t                 `----; |                                                 \n");
    printf("\t\t\t\t\t        =========================================================================\n");
    ...
    */
    void display_seat_map(int schedule_id, Studio* studio) {
        ...
        printf(GREEN"\t\t\t\t[ A1 ] Available"RESET);
        printf("    ");
        printf(RED"[ X ] Booked"RESET);
    ...
    */
    ...
    void menu_admin() {
        ...
        do {
            ...
            printf(GOLD "[1] " RESET "Film Management\n");
            printf(GOLD "[2] " RESET "Studio & Schedule Management\n");
            printf(GOLD "[3] " RESET "User Account Management\n");
    ...
    void film_manage() {
        ...
        do {
            ...
            printf("" GOLD "[1] " RESET "View All Films\n");
            printf("" GOLD "[2] " RESET "Search Film\n");
            printf("" GOLD "[3] " RESET "Add New Film\n");
            printf("" GOLD "[4] " RESET "Delete Film\n");
            printf("" GOLD "[5] " RESET "Edit Film Info\n");
    ...
    void schedule_manage() {
        ...
        do {
            ...
            printf("" GOLD  "[1] " RESET "View All Studios\n");
            printf("" GOLD  "[2] " RESET "View All Schedules\n");
            printf("" GOLD "[3] " RESET "Add New Studio\n");
            printf("" GOLD  "[4] " RESET "Edit Studio\n");
            printf("" GOLD   "[5] " RESET "Delete Studio\n");
            printf("" GOLD "[6] " RESET "Add Schedule\n");
            printf("" GOLD  "[7] " RESET "Edit Schedule\n");
            printf("" GOLD   "[8] " RESET "Delete Schedule\n");
            printf("" RED "[0] " RESET "Back\n");
    ...
    void acc_manage() {
        ...
        do {
            ...
            printf("" GOLD  "[1] " RESET "View All Users\n");
            printf("" GOLD  "[2] " RESET "Search User\n");
            printf("" GOLD   "[3] " RESET "Delete User Account\n");
            printf("" RED   "[0] " RESET "Back\n");
    ...
    void book_ticket() {
        ...
        do {
            system("cls");
            book_ticket_banner();
            printf("\n\t\t\t\t\t\t\t\t\t[ STEP 1 ] " GOLD"Pilih Film\n"RESET);

            /* Cetak tabel film Pembatas Atas Tabel Film */
            printf(GOLD"\t\t\t\t=================================================================================================\n"RESET);

            printf(GOLD"\t\t\t\t| %-5s | %-35s | %-25s | %-10s | %-6s |\n"RESET,
                "ID", "TITLE", "GENRE", "DURATION", "AGE");
            ...
            for (int i = 0; i < film_count; i++) {
                ...
                printf("\t\t\t\t| %-5d | %-35.35s | %-25.25s | %-10d | %-6d |\n",
                    all_films[i].id,
                    all_films[i].title,
                    all_films[i].genre,
                    all_films[i].duration,
                    all_films[i].age_rating);
            }

            printf(GOLD"\t\t\t\t=================================================================================================\n"RESET);
           
            printf(GOLD"\n\t\t\t\t\t\tMasukkan Film ID atau Judul (Ketik '0' untuk Batal) : "RESET);
            fgets(input, sizeof(input), stdin);
            input[strcspn(input, "\n")] = '\0';
            ...
            if (strlen(input) == 0) {
                printf(RED "\n\t\t\t\t\t\t[ERROR] " RESET GOLD"Input tidak boleh kosong!\n"RESET);
                system("pause");
                continue;
            }
            ...
            if (match_count == 0) {
                printf(RED"\t\t\t\t\t\t[ERROR]"RESET GOLD" Film \"%s\" tidak ditemukan! Silakan coba lagi.\n"RESET, input);
                getchar();
            } else if (match_count == 1) {
                film_id = matched[0].id;
            } else {
                ...
                do {
                    system("cls");
                    book_ticket_banner();
                    printf(GOLD"\n\t\t\t\t\t\t           Beberapa film ditemukan untuk pencarian" RESET " \"%s\":\n", input);
                    printf(GOLD"\t\t\t\t\t\t           --------------------------------------------\n"RESET);
                    for (int i = 0; i < match_count; i++) {
                        printf("\t\t\t\t\t\t           ID: %-4d | Title: %s\n", matched[i].id, matched[i].title);
                    }
                    printf(GOLD"\t\t\t\t\t\t           --------------------------------------------\n"RESET);
                    printf(GOLD"\t\t\t\t\t\t           Masukkan EXACT ID dari daftar di atas\n");
                    printf("\t\t\t\t\t\t            (atau '0' untuk kembali) : "RESET);
                    ...
                    if (strlen(id_input) == 0) { 
                        printf(RED"\t\t\t\t\t\t            [ERROR]"RESET " Input tidak boleh kosong!\n"); 
                        getchar();
                        continue; 
                    }
                    ...
                    if (!id_is_num) {
                        printf(RED"\t\t\t\t\t\t            [ERROR]"RESET" Invalid input! Harus berupa ID angka.\n");
                        getchar();
                        continue;
                    }
                    ...
                    if (!resolved) {
                        printf(RED"\t\t\t\t\t\t            [ERROR]" RESET" ID %d tidak ada dalam daftar di atas!\n", selected_id);
                        getchar();
                    }
                } while (!resolved);
            }
            ...
            if (film_id != -1) {
                ...
                if (chosen_film == NULL) {
                    printf(RED"\t\t\t\t\t\t            [ERROR]" RESET" Terjadi kesalahan. Film tidak ditemukan!\n");
                    system("pause");
        ...
        do {
            system("cls");
            book_ticket_banner();
            printf("\n\t\t\t\t\t\t\t[ STEP 2 ] " GOLD"Pilih Jadwal untuk \"%s\"\n"RESET, chosen_film->title);
            ...
            for (int i = 0; i < sch_count; i++) {
                ...
                char price_str[20];
                sprintf(price_str, "%.0fK", match_schedules[i].price / 1000);

                printf("\t\t\t\t| %-5d | %-35.35s | %-25.25s | %-10s | %-6s |\n",
                    match_schedules[i].id,
                    st_name,
                    match_schedules[i].date,
                    match_schedules[i].time,
                    price_str);
            }

            printf(GOLD"\t\t\t\t=================================================================================================\n"RESET);

            printf(GOLD"\n\t\t\t\t\t\tMasukkan Schedule ID (Ketik '0' untuk Batal) : "RESET);
            fgets(input, sizeof(input), stdin);
            input[strcspn(input, "\n")] = '\0';
            ...
            if (strlen(input) == 0) {
                printf(RED "\n\t\t\t\t\t\t[ERROR]"RESET" ID tidak boleh kosong!\n");
                getchar();
                valid = 0;
                continue;
            }
            ...
            if (!valid) {
                printf(RED"\n\t\t\t\t\t\t[ERROR]"RESET" ID harus berupa angka!\n");
                getchar();
                continue;
            }
            ...
            if (!find_schedule(schedule_id, &chosen_sch)) {
                printf(RED"\n\t\t\t\t\t\t[ERROR]"RESET" Jadwal dengan ID %d tidak ditemukan!\n", schedule_id);
                getchar();
                valid = 0;
                continue;
            }
            if (chosen_sch.film_id != film_id) {
                printf(RED"\n\t\t\t\t\t\t[ERROR]"RESET" Jadwal ID %d bukan untuk film \"%s\"!\n", schedule_id, chosen_film->title);
                getchar();
                valid = 0;
                continue;
            }
        ...
        while (seat_count < MAX_SEATS_PER_ORDER) {
            ...
            printf("\n");
            printf("\n\t\t\t\t\t\t\t\t        [ STEP 3 ] " GOLD"Pilih Seat\n"RESET);
            printf(GOLD"\t\t\t\t=================================================================================================\n"RESET);
            printf(GOLD"\t\t\t\t|                                    Maximum seat selection : %d                                 |\n"RESET, MAX_SEATS_PER_ORDER);
            printf(GOLD"\t\t\t\t|                                   Type DONE to continue booking                               |\n"RESET);
            printf(GOLD"\t\t\t\t|                                      Type 0 to cancel booking                                 |\n"RESET);
            printf(GOLD"\t\t\t\t=================================================================================================\n"RESET);

            /* Tampilkan Denah Kursi */
            display_seat_map(schedule_id, &chosen_studio);

            /* Tampilkan Kursi Yang Sudah Dipilih */
            if (seat_count > 0) {

                printf("\n");

                printf(GOLD"\t\t\t\tSelected Seats : "RESET);

                for (int i = 0; i < seat_count; i++) {

                    printf(GREEN"%s"RESET, selected_seats[i]);
            ...
            printf(GOLD"\t\t\t\tSeat #%d (DONE / 0) : "RESET, seat_count + 1);
            ...
            if (!validate_seat_format(seat_input, &chosen_studio)) {
                ...
                printf(
                    RED"\n\t\t\t\t[ERROR] Invalid seat %s! Valid rows A-%c, Columns 1-%d\n"RESET,
                    seat_input,
            ...
            if (is_seat_booked(schedule_id, seat_input)) {
                ...
                printf(
                    RED"\n\t\t\t\t[ERROR] Seat %s has already been booked!\n"RESET,
                    seat_input
                );
            ...
            if (duplicate) {
                ...
                printf(
                    RED"\n\t\t\t\t[ERROR] Seat %s is already selected!\n"RESET,
                    seat_input
                );
            ...
            printf(
                GREEN"\n\t\t\t\t[SUCCESS] Seat %s added successfully!\n"RESET,
                seat_input
            );
        ...
        do {
            ...
            printf("\n");
            printf("\n\t\t\t\t\t\t\t\t      [ STEP 5 ] " GOLD"Booking Confirmation\n"RESET);
            printf(GOLD"\t\t\t\t=================================================================================================\n"RESET);
            printf(GOLD"\t\t\t\tFilm      : "RESET "%s\n", chosen_film->title);
            printf(GOLD"\t\t\t\tStudio    : "RESET "%s\n", chosen_studio.name);
            printf(GOLD"\t\t\t\tDate      : "RESET "%s\n", chosen_sch.date);
            printf(GOLD"\t\t\t\tTime      : "RESET "%s\n", chosen_sch.time);

            printf(GOLD"\t\t\t\tSeats     : "RESET);
            ...
            printf(GOLD"\t\t\t\tQuantity  : "RESET "%d Seats\n", seat_count);

            printf(GOLD"\t\t\t\tPrice     : "RESET "Rp %.0f x %d = Rp %.0f\n",
                chosen_sch.price,
                seat_count,
                total_harga);
            ...
            printf(GOLD"\t\t\t\tConfirm Booking? "RESET "[Y/N] : ");

            fgets(confirm_str, sizeof(confirm_str), stdin);
            confirm_str[strcspn(confirm_str, "\n")] = '\0';

            if (strlen(confirm_str) == 0) {
                printf(RED"\n\t\t\t\t[ERROR] Input cannot be empty! Please enter Y or N.\n"RESET);
                getchar();
                continue;
            }
            ...
            if (strcmp(confirm_str, "Y") == 0 || strcmp(confirm_str, "y") == 0) {
                ...
                printf(RED"\n\t\t\t\t[ERROR] Input is not valid! Please enter Y or N.\n"RESET);
                getchar();
            }
        } while (!conf_valid);
        ...
        printf(GOLD"\t\t\t\t=================================================================================================\n"RESET);
        printf(GOLD"\t\t\t\t|                                      BOOKING SUCCESSFUL                                        |\n"RESET);
        printf(GOLD"\t\t\t\t=================================================================================================\n"RESET);
        ...
        printf(GOLD"\t\t\t\tTotal Price  : "RESET GREEN "Rp %.0f\n" RESET, total_harga);

        printf("\n");

        printf(GOLD"\t\t\t\t=================================================================================================\n"RESET);
        printf(GOLD"\t\t\t\t| %-10s | %-30s |\n"RESET, "SEAT", "BOOKING CODE");
        printf(GOLD"\t\t\t\t=================================================================================================\n"RESET);

        for (int i = 0; i < seat_count; i++) {

            printf("\t\t\t\t| " GREEN "%-10s" RESET " | " CYAN "%-30s" RESET " |\n",
                selected_seats[i],
                saved_codes[i]);
        }
        ...
        printf(GREEN"\t\t\t\t[SUCCESS] Booking completed successfully!\n"RESET);
        printf(CYAN"\t\t\t\tPlease save your booking code(s).\n"RESET);

        printf("\n");

        printf(GOLD"\t\t\t\tPress any key to return to menu..."RESET);
    ...
    void history() {
        ...
        printf("\n");
        printf(GOLD"\t\t\t\t=================================================================================================\n"RESET);
        printf(GOLD"\t\t\t\t| %-15s | %-25s | %-10s | %-10s | %-8s | %-10s |\n"RESET,
            "BOOKING CODE", "FILM", "DATE", "TIME", "SEAT", "STATUS");
        printf(GOLD"\t\t\t\t=================================================================================================\n"RESET);
    ...
    printf(GOLD"\t\t\t\t\t\tMasukkan Booking Code yang ingin dibatalkan\n");
    printf("\t\t\t\t\t\t(Ketik '0' untuk kembali) : "RESET);
    ...
    if (strlen(code_input) == 0) {
        printf(RED"\n\t\t\t\t[ERROR] Booking code tidak boleh kosong!\n"RESET);
        system("pause");
        continue;
    }
    ...
    if (!find_booking(code_input, &target)) {
        printf(RED"\n\t\t\t\t[ERROR] Booking Code \"%s\" tidak ditemukan!\n"RESET,
               code_input);
        system("pause");
        continue;
    }
    ...
    if (strcmp(target.username, current_user) != 0) {
        printf(RED"\n\t\t\t\t[ERROR] Booking ini bukan milik Anda!\n"RESET);
        system("pause");
        continue;
    }

    if (target.status != 1) {
        printf(RED"\n\t\t\t\t[ERROR] Booking %s sudah dibatalkan sebelumnya!\n"RESET,
               code_input);
        system("pause");
        continue;
    }
    ...
    do {
        ...
        printf("\t\t\t\t\t\t      " GOLD "[1]" RESET " Validate Ticket (Check-In)\n");
        printf("\t\t\t\t\t\t      " GOLD "[2]" RESET " Sell Ticket\n");
        printf("\t\t\t\t\t\t      " GOLD "[3]" RESET " Seat Status Per Schedule\n");
        printf("\t\t\t\t\t\t      " RED  "[0]" RESET " Logout\n");
        ...
        if (choice < 0 || choice > 3) {
            ...
            printf("\t\t\t\t\t\t      Please choose between 0 - 3.\n");
            printf(RESET);
            system("pause");
        }
